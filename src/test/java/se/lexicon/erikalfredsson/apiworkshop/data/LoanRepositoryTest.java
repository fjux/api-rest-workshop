...
class LoanRepositoryTest {
    ...
    private Loan loan5 = new Loan(userOne, bookFive, LocalDate.parse("2020-12-07"), true);
    private Loan loan6 = new Loan(userTwo, bookFive, LocalDate.parse("2020-05-15"), true);
    private Loan loan7 = new Loan(userThree, bookFive, LocalDate.parse("2021-01-10"), true);
